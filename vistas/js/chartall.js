...
const calculateCurveProjected = async () => {
    ...
    try {
        ...
        let confirmed = [];
        const curveExponential = [4,5,7,10,13,18,25,34,47,64,88,120,165,225,308,422,577,790,1080,1478,2022,2820,5400];
        const curvePotencial = [1,6,3,3,8,16,28,44,64,88,116,148,184,223,267,314,366,391,421,480,560,649,750,861,984,1117,1260,1410,1567,1728,1890,2051,2209,2361,2505,2640,2765,2879];
