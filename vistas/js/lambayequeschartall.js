const loadAllHistoricDataLambayeque = async () => {
    ...
    try {
        const resAllDataLambayeque = await getData(`${BASE_API}`)
        ...
        new Chart(ctx,
        {
            ...
            "data":{
                "labels": days,
                "datasets":[{
                    "label":"Cantidad de Confirmados Por Día - Lambayeque",
                    "data":confirmed,
                    "fill":false,
                    "borderColor":"red",
                    "lineTension":0
        ...
        let ctx3 = document.getElementById("chart4");
        new Chart(ctx3,
        {
            "type":"line",
            "data":{
