const loadAllHistoricDataByRegion = async (region) => {
    ...
    try {
        ...
        switch (region) {
            case 'AMAZONAS':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.AMAZONAS[strDate])
                }
                break;
            case 'ÁNCASH':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.ÁNCASH[strDate])
                }
                break;
            case 'APURÍMAC':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.APURÍMAC[strDate])
                }
                break;
            case 'AREQUIPA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.AREQUIPA[strDate])
                }
                break;
            case 'AYACUCHO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.AYACUCHO[strDate])
                }
                break;
            case 'CAJAMARCA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.CAJAMARCA[strDate])
                }
                break;
            case 'CALLAO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.CALLAO[strDate])
                }
                break;
            case 'CUSCO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.CUSCO[strDate])
                }
                break;
            case 'HUANCAVELICA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.HUANCAVELICA[strDate])
                }
                break;
            case 'HUÁNUCO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.HUÁNUCO[strDate])
                }
                break;
            case 'ICA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.ICA[strDate])
                }
                break;
            case 'JUNÍN':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.JUNÍN[strDate])
                }
                break;
            case 'LA_LIBERTAD':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.LA_LIBERTAD[strDate])
                }
                break;
            case 'LAMBAYEQUE': 
            ...
            case 'LIMA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.LIMA[strDate])
                }
                break;
            case 'LORETO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.LORETO[strDate])
                }
                break;
            case 'MADRE_DE_DIOS':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.MADRE_DE_DIOS[strDate])
                }
                break;
            case 'MOQUEGUA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.MOQUEGUA[strDate])
                }
                break;
            case 'PASCO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.PASCO[strDate])
                }
                break;
            case 'PIURA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.PIURA[strDate])
                }
                break;
            case 'PUNO':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.PUNO[strDate])
                }
                break;
            case 'SAN_MARTÍN':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.SAN_MARTÍN[strDate])
                }
                break;
            case 'TACNA':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.TACNA[strDate])
                }
                break;
            case 'TUMBES':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.TUMBES[strDate])
                }
                break;
            case 'UCAYALI':          
                ...
                {
                    days.push(strDate);
                    confirmed.push(resAllDataRegions[0].Provinces.UCAYALI[strDate])
                }
                break;
            default:
                break;
        ...
        createGraph(region, days, confirmed)
...
const loadRegions = async () => {
    ...
    try {
        const resAllRegions = await getData(`${BASE_API}`)        

        for (strNameProvince in resAllRegions[0].Provinces)
        {
            let option = document.createElement("option");
            option.text = `${strNameProvince}`;
            option.value = `${strNameProvince}`;
            let select = document.getElementById("idDep");
            select.appendChild(option);
        }

        document.getElementById("idDep").onchange = () => {loadAllHistoricDataByRegion(document.getElementById("idDep").value)}
...
const createGraph = (region, days, confirmed) => {
    let ctx = document.getElementById("chartRegion");
    new Chart(ctx,
    {
        "type":"line",
        "data":{
            "labels": days,
            "datasets":[{
                "label": `Cantidad de Confirmados Por Día - ${region}`,
                "data":confirmed,
                "fill":false,
                "borderColor":"red",
                "lineTension":0
